<<<<<<< HEAD
# Bitácora y Monitoreo - hospital_230142
...
<td align="center" style="border: none; padding: 10px;"><img src="https://img.shields.io/badge/Feature-Monitoring-green?style=flat-square" alt="Monitoring"/></td>
</tr>
</table>

## ¿Qué es la Bitácora y Monitoreo?

La bitácora y monitoreo es un conjunto de mecanismos y herramientas de auditoría diseñadas para registrar, controlar y supervisar todos los cambios realizados en la base de datos. Proporciona un registro completo de quién, qué, cuándo y cómo se modificaron los datos, así como el estado y desempeño de los respaldos del sistema.
